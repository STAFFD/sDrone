...
void loop(){
  ...
  if(error == 0){
    ...
    center_channel_1 = receiver_input[0];
    center_channel_2 = receiver_input[1];
    center_channel_3 = receiver_input[2];
    center_channel_4 = receiver_input[3];
    Serial.println(F(""));
...
void check_receiver_inputs(byte movement){
  ...
  while(timer > millis() && trigger == 0){
    delay(250);
    if(receiver_input[0] > 1750 || receiver_input[0] < 1250){
      trigger = 1;
      receiver_check_byte |= 0b00000001;
      pulse_length = receiver_input[0];
    }
    if(receiver_input[1] > 1750 || receiver_input[1] < 1250){
      trigger = 2;
      receiver_check_byte |= 0b00000010;
      pulse_length = receiver_input[1];
    }
    if(receiver_input[2] > 1750 || receiver_input[2] < 1250){
      trigger = 3;
      receiver_check_byte |= 0b00000100;
      pulse_length = receiver_input[2];
    }
    if(receiver_input[3] > 1750 || receiver_input[3] < 1250){
      trigger = 4;
      receiver_check_byte |= 0b00001000;
      pulse_length = receiver_input[3];
    } 
  }
  if(trigger == 0){
    error = 1;
...
void check_to_continue(){
  ...
  while(continue_byte == 0){
    if(channel_2_assign == 0b00000001 && receiver_input[0] > center_channel_1 + 150)continue_byte = 1;
    if(channel_2_assign == 0b10000001 && receiver_input[0] < center_channel_1 - 150)continue_byte = 1;
    if(channel_2_assign == 0b00000010 && receiver_input[1] > center_channel_2 + 150)continue_byte = 1;
    if(channel_2_assign == 0b10000010 && receiver_input[1] < center_channel_2 - 150)continue_byte = 1;
    if(channel_2_assign == 0b00000011 && receiver_input[2] > center_channel_3 + 150)continue_byte = 1;
    if(channel_2_assign == 0b10000011 && receiver_input[2] < center_channel_3 - 150)continue_byte = 1;
    if(channel_2_assign == 0b00000100 && receiver_input[3] > center_channel_4 + 150)continue_byte = 1;
    if(channel_2_assign == 0b10000100 && receiver_input[3] < center_channel_4 - 150)continue_byte = 1;
    delay(100);
  }
  wait_sticks_zero();
}
...
void wait_sticks_zero(){
  byte zero = 0;
  while(zero < 15){
    if(receiver_input[0] < center_channel_1 + 20 && receiver_input[0] > center_channel_1 - 20)zero |= 0b00000001;
    if(receiver_input[1] < center_channel_2 + 20 && receiver_input[1] > center_channel_2 - 20)zero |= 0b00000010;
    if(receiver_input[2] < center_channel_3 + 20 && receiver_input[2] > center_channel_3 - 20)zero |= 0b00000100;
    if(receiver_input[3] < center_channel_4 + 20 && receiver_input[3] > center_channel_4 - 20)zero |= 0b00001000;
    delay(100);
  }
}
...
void wait_for_receiver(){
  ...
  while(timer > millis() && zero < 15){
    if(receiver_input[0] < 2100 && receiver_input[0] > 900)zero |= 0b00000001;
    if(receiver_input[1] < 2100 && receiver_input[1] > 900)zero |= 0b00000010;
    if(receiver_input[2] < 2100 && receiver_input[2] > 900)zero |= 0b00000100;
    if(receiver_input[3] < 2100 && receiver_input[3] > 900)zero |= 0b00001000;
    delay(500);
    Serial.print(F("."));
  }
  if(zero == 0){
...
void register_min_max(){
  byte zero = 0;
  low_channel_1 = receiver_input[0];
  low_channel_2 = receiver_input[1];
  low_channel_3 = receiver_input[2];
  low_channel_4 = receiver_input[3];
  while(receiver_input[0] < center_channel_1 + 20 && receiver_input[0] > center_channel_1 - 20)delay(250);
  ...
  while(zero < 15){
    ...
    if(receiver_input[2] < center_channel_3 + 20 && receiver_input[2] > center_channel_3 - 20)zero |= 0b00000100;
    if(receiver_input[3] < center_channel_4 + 20 && receiver_input[3] > center_channel_4 - 20)zero |= 0b00001000;
    if(receiver_input[0] < low_channel_1)low_channel_1 = receiver_input[0];
    if(receiver_input[1] < low_channel_2)low_channel_2 = receiver_input[1];
    if(receiver_input[2] < low_channel_3)low_channel_3 = receiver_input[2];
    if(receiver_input[3] < low_channel_4)low_channel_4 = receiver_input[3];
    if(receiver_input[0] > high_channel_1)high_channel_1 = receiver_input[0];
    if(receiver_input[1] > high_channel_2)high_channel_2 = receiver_input[1];
    if(receiver_input[2] > high_channel_3)high_channel_3 = receiver_input[2];
    if(receiver_input[3] > high_channel_4)high_channel_4 = receiver_input[3];
    delay(100);
  }
}
