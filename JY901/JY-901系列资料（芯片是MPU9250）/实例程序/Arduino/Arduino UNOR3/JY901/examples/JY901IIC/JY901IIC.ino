...
//  
  JY901.GetGyro();  
  wx = wx * 0.9 + ((float)JY901.stcGyro.w[0]/32768*2000) * 0.1;
  wy = wy * 0.9 + ((float)JY901.stcGyro.w[1]/32768*2000) * 0.1;
  wz = wz * 0.9 + ((float)JY901.stcGyro.w[2]/32768*2000) * 0.1;
  
  Serial.print("Gyro:");Serial.print(wx);Serial.print(" ");Serial.print(wy);Serial.print(" ");Serial.println(wz);
